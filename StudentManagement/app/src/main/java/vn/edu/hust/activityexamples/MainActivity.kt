...
class MainActivity : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    studentList.add("Đỗ Thùy Dương - 20215019")
    studentList.add("Lê Thị Nhung - 20211111")
    studentList.add("Đặng Hải Mai Linh -20212222")
    studentList.add("Hà Quỳnh Trang -20213333")
    studentList.add("Đinh Minh Ánh -20214444")
    studentList.add("Phạm Vân Anh -20215555")
